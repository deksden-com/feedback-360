    ...
    cards: [
      {
        ...
        href: "/hr/employees",
        ctaLabel: isAdmin ? "Открыть справочник" : "Открыть сотрудников",
        testId: "home-card-active-employees",
        ctaTestId: "home-cta-active-employees",
      },
      {
        title: "Оргструктура",
        value: isAdmin ? "Edit" : "View",
        description: isAdmin
          ? "Поддерживайте отделы, руководителей и перемещения сотрудников в одном org editor."
          : "Просматривайте departments и текущее состояние сотрудников в read-only режиме.",
        href: "/hr/org",
        ctaLabel: "Открыть оргструктуру",
        testId: "home-card-hr-org",
        ctaTestId: "home-cta-hr-org",
      },
      {
        title: "HR кампании",
        value: "360",
        description: "Откройте workbench кампаний и управляйте lifecycle 360-процессов.",
        href: "/hr/campaigns",
