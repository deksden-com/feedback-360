...
- Nameservers: домен делегирован на Vercel NS (`ns1.vercel-dns.com`, `ns2.vercel-dns.com`).
- Resend domain status: `go360go.ru` = `verified` (DKIM/SPF verified).
...
- Type: `TXT`
- Name: `_dmarc`
- Value: `v=DMARC1; p=quarantine; pct=100; adkim=s; aspf=s` (после интеграции SimpleLogin используется строгая политика).
...
- 2026-03-04: DNS записи Resend добавлены в Vercel DNS.
...
- 2026-03-04: делегирование NS на Vercel завершено.
- 2026-03-04: домен `go360go.ru` в Resend перешёл в `verified`.
