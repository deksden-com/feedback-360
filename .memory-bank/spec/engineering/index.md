...
- [Delivery standards](delivery-standards.md) — правила git flow дисциплины, commit traceability, acceptance gate и фиксации evidence. Читать перед закрытием фичи, чтобы “Completed” всегда подтверждалось проверками и артефактами.
- [Testing standards](testing-standards.md) — уровни тестов, seeds как контракт, golden сценарии. Читать, чтобы DoD фичи был проверяемым и воспроизводимым.
