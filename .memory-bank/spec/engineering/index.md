...
- [UI design system](../ui/design-system/index.md) — visual tokens, semantic colors, component rules и sync policy. Читать перед UI polish/refactor, чтобы screen-level изменения ложились в единый продуктовый язык.
