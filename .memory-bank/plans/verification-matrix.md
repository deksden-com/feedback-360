...
- FT-0151: what=employee results dashboard refresh with summary/KPI/group/competency cards; where=local workspace; how=`pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0083-results-ui.spec.ts tests/ft-0151-employee-results-dashboard.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally; artifacts=`.memory-bank/evidence/EP-015/FT-0151/2026-03-06/`; result=passed.
- FT-0152: what=manager team dashboard with subject switcher and anonymity explanations; where=local workspace; how=`pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0083-results-ui.spec.ts tests/ft-0152-manager-results-dashboard.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally; artifacts=`.memory-bank/evidence/EP-015/FT-0152/2026-03-06/`; result=passed.
- FT-0153: what=HR results workbench with role-aware raw/processed controls; where=local workspace; how=`pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0101-results-privacy.spec.ts tests/ft-0153-hr-results-workbench.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally; artifacts=`.memory-bank/evidence/EP-015/FT-0153/2026-03-06/`; result=passed.
