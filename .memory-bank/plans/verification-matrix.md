...
- FT-0212
  - Must add test: `apps/web/playwright/tests/ft-0212-testid-normalization.spec.ts`
  - Must run: normalized selector proof for employees/org/questionnaires/results on local + `beta`.
- FT-0213
  - Must add test: `apps/web/playwright/tests/ft-0213-shell-identity-chrome.spec.ts`
  - Must run: shell/account chrome and grouped nav proof on local + `beta`.
- FT-0214
  - Must add test: `apps/web/playwright/tests/ft-0214-hr-crud-hierarchy-polish.spec.ts`
  - Must run: employee directory/profile/org hierarchy walkthrough on local + `beta`.
- FT-0215
  - Must add test: `apps/web/playwright/tests/ft-0215-content-first-surfaces.spec.ts`
  - Must run: questionnaire inbox/fill and employee/manager/HR results hierarchy proof on local + `beta`.
...
- FT-0212: what=normalized `data-testid` scopes for high-value route surfaces; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3108 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0212-testid-normalization.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0212-testid-normalization.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-021/FT-0212/2026-03-07/step-01-normalized-selectors__(SCR-RESULTS-HR).png`; deploy=`https://go360go-beta-k1gq49uel-deksdens-projects.vercel.app`; result=passed.
- FT-0213: what=SaaS-like shell chrome with account context, grouped nav and clearer identity; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3108 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0111-app-shell.spec.ts tests/ft-0213-shell-identity-chrome.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0111-app-shell.spec.ts tests/ft-0213-shell-identity-chrome.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-021/FT-0213/2026-03-07/step-01-shell-account-menu__(SCR-APP-HOME).png`; deploy=`https://go360go-beta-k1gq49uel-deksdens-projects.vercel.app`; result=passed.
...
- FT-0143: what=web/lib feature-area realignment, docs sync and route regression proof; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3102 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0143-slice-refactor-regression.spec.ts --workers=1 --reporter=line`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0143-slice-refactor-regression.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; deployment=`https://go360go-beta-8obl8oe7c-deksdens-projects.vercel.app`; artifacts=`.memory-bank/evidence/EP-014/FT-0143/2026-03-06/`; result=passed.
...
- FT-0151: what=employee results dashboard refresh with summary/KPI/group/competency cards; where=local workspace + `https://beta.go360go.ru`; how=`pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0083-results-ui.spec.ts tests/ft-0151-employee-results-dashboard.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0083-results-ui.spec.ts tests/ft-0151-employee-results-dashboard.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; ci_run=`https://github.com/deksden-com/feedback-360/actions/runs/22772277748`; deploy=`https://go360go-beta-ichra2bma-deksdens-projects.vercel.app`; artifacts=`.memory-bank/evidence/EP-015/FT-0151/2026-03-06/`; result=passed.
- FT-0152: what=manager team dashboard with subject switcher and anonymity explanations; where=local workspace + `https://beta.go360go.ru`; how=`pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0083-results-ui.spec.ts tests/ft-0152-manager-results-dashboard.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0083-results-ui.spec.ts tests/ft-0152-manager-results-dashboard.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; ci_run=`https://github.com/deksden-com/feedback-360/actions/runs/22772277748`; deploy=`https://go360go-beta-ichra2bma-deksdens-projects.vercel.app`; artifacts=`.memory-bank/evidence/EP-015/FT-0152/2026-03-06/`; result=passed.
- FT-0153: what=HR results workbench with role-aware raw/processed controls; where=local workspace + `https://beta.go360go.ru`; how=`pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0101-results-privacy.spec.ts tests/ft-0153-hr-results-workbench.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0101-results-privacy.spec.ts tests/ft-0153-hr-results-workbench.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; ci_run=`https://github.com/deksden-com/feedback-360/actions/runs/22772277748`; deploy=`https://go360go-beta-ichra2bma-deksdens-projects.vercel.app`; artifacts=`.memory-bank/evidence/EP-015/FT-0153/2026-03-06/`; result=passed.
...
- FT-0161: what=employee directory with search, department/status filters and profile deep links; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-016`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://localhost:3105 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0161-employee-directory.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0161-employee-directory.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-016/FT-0161/2026-03-06/`; deploy=`https://beta.go360go.ru`; result=passed.
- FT-0162: what=employee create/edit profile and account provisioning flow with role-aware controls; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-016`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://localhost:3105 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0162-employee-profile-provisioning.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0162-employee-profile-provisioning.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-016/FT-0162/2026-03-06/`; deploy=`https://beta.go360go.ru`; result=passed.
- FT-0163: what=department tree, manager assignment and employee move UI with history-aware updates; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-016`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://localhost:3105 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0163-org-editor.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0163-org-editor.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-016/FT-0163/2026-03-06/`; deploy=`https://beta.go360go.ru`; result=passed.
...
- FT-0171: what=model catalog/version hub with kind-status filters, usage hints and clone draft flow; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0171-model-catalog.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0171-model-catalog.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-017/FT-0171/2026-03-06/`; deploy=`https://beta.go360go.ru`; result=passed.
- FT-0172: what=draft-first model editor for indicators/levels with weight validation and publish/read-only flow; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm --filter @feedback-360/cli test -- --runInBand src/ft-0171-models-matrix-cli.test.ts`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0172-model-editor.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0172-model-editor.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-017/FT-0172/2026-03-06/`; deploy=`https://beta.go360go.ru`; result=passed.
- FT-0173: what=campaign matrix builder with department autogen, save flow and lock/read-only preview; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm --filter @feedback-360/cli test -- --runInBand src/ft-0171-models-matrix-cli.test.ts`, `cd apps/web && PLAYWRIGHT_BASE_URL=http://127.0.0.1:3101 node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0173-matrix-builder.spec.ts --workers=1 --reporter=line`, `cd apps/web && PLAYWRIGHT_BASE_URL=https://beta.go360go.ru node ../../node_modules/@playwright/test/cli.js test --config playwright/playwright.config.mjs tests/ft-0173-matrix-builder.spec.ts --workers=1 --reporter=line`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-017/FT-0173/2026-03-06/`; deploy=`https://beta.go360go.ru`; result=passed.
...
- FT-0181: what=reminder schedule editor with typed settings get/upsert/preview and timezone-aware next-run preview; where=local workspace + `https://beta.go360go.ru`; how=`pnpm lint`, `pnpm typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/web build`, `PLAYWRIGHT_BASE_URL=http://127.0.0.1:3104 pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0181-reminder-schedule-editor.spec.ts --workers=1`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0181-reminder-schedule-editor.spec.ts --workers=1`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-018/FT-0181/2026-03-06/step-01-reminder-editor.png`; deploy=`https://beta.go360go.ru`; result=passed.
- FT-0182: what=template catalog and preview panel with canonical metadata/variables via typed ops and CLI parity; where=local workspace + `https://beta.go360go.ru`; how=`pnpm lint`, `pnpm typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/cli exec vitest run src/ft-0181-notification-center-cli.test.ts`, `PLAYWRIGHT_BASE_URL=http://127.0.0.1:3104 pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0182-template-catalog.spec.ts --workers=1`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0182-template-catalog.spec.ts --workers=1`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-018/FT-0182/2026-03-06/step-01-template-preview.png`; deploy=`https://beta.go360go.ru`; result=passed.
- FT-0183: what=delivery diagnostics/outbox view with filters, retry/fail badges and attempt drill-down; where=local workspace + `https://beta.go360go.ru`; how=`pnpm lint`, `pnpm typecheck`, `pnpm --filter @feedback-360/web test`, `pnpm --filter @feedback-360/cli exec vitest run src/ft-0181-notification-center-cli.test.ts`, `PLAYWRIGHT_BASE_URL=http://127.0.0.1:3104 pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0183-delivery-diagnostics.spec.ts --workers=1`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0183-delivery-diagnostics.spec.ts --workers=1`; quality_gate=passed; acceptance_gate=passed locally and on beta; artifacts=`.memory-bank/evidence/EP-018/FT-0183/2026-03-06/step-01-delivery-diagnostics.png`; deploy=`https://beta.go360go.ru`; result=passed.
...
- FT-0191: what=`/ops` health and release dashboard with environment/build/integration checks; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-019`, `PLAYWRIGHT_BASE_URL=http://127.0.0.1:3107 pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0191-health-release-dashboard.spec.ts --workers=1`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0191-health-release-dashboard.spec.ts --workers=1`; quality_gate=passed; acceptance_gate=passed locally and on beta; ci_run=`https://github.com/deksden-com/feedback-360/actions/runs/22784079545`; browser_smoke=`https://github.com/deksden-com/feedback-360/actions/runs/22784170563`; deploy=`https://beta.go360go.ru`; artifacts=`.memory-bank/evidence/EP-019/FT-0191/2026-03-06/step-01-health-release-dashboard.png`; result=passed.
- FT-0192: what=AI jobs + webhook receipt diagnostics with duplicate delivery marker; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-019`, `pnpm --filter @feedback-360/cli exec vitest run src/ft-019-ops-cli.test.ts`, `PLAYWRIGHT_BASE_URL=http://127.0.0.1:3107 pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0192-ai-diagnostics.spec.ts --workers=1`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0192-ai-diagnostics.spec.ts --workers=1`; quality_gate=passed; acceptance_gate=passed locally and on beta; ci_run=`https://github.com/deksden-com/feedback-360/actions/runs/22784079545`; browser_smoke=`https://github.com/deksden-com/feedback-360/actions/runs/22784170563`; deploy=`https://beta.go360go.ru`; artifacts=`.memory-bank/evidence/EP-019/FT-0192/2026-03-06/step-01-ai-diagnostics.png`; result=passed.
- FT-0193: what=audit/release console with `hr_reader` redaction boundaries; where=local workspace + `https://beta.go360go.ru`; how=`pnpm checks`, `pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-019`, `PLAYWRIGHT_BASE_URL=http://127.0.0.1:3107 pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0193-audit-console.spec.ts --workers=1`, `PLAYWRIGHT_BASE_URL=https://beta.go360go.ru pnpm --filter @feedback-360/web exec playwright test --config playwright/playwright.config.mjs tests/ft-0193-audit-console.spec.ts --workers=1`; quality_gate=passed; acceptance_gate=passed locally and on beta; ci_run=`https://github.com/deksden-com/feedback-360/actions/runs/22784079545`; browser_smoke=`https://github.com/deksden-com/feedback-360/actions/runs/22784170563`; deploy=`https://beta.go360go.ru`; artifacts=`.memory-bank/evidence/EP-019/FT-0193/2026-03-06/step-01-audit-console.png`; result=passed.

## EP-020 Cross-epic scenarios (XE) foundation
- FT-0201
  - Must add test: `packages/db/src/ft/ft-0201-xe-run-lifecycle.test.ts`
  - Must run: `xe runs create/delete`, lock acquire/release and expired cleanup semantics.
- FT-0202
  - Must add test: `packages/xe-runner/src/ft-0205-scenarios.test.ts`
  - Must run: named seed apply for `XE-001-first-campaign` with deterministic bindings persisted into run state.
- FT-0203
  - Must add test: `packages/cli/src/ft-0204-xe-cli.test.ts`
  - Must run: notification intents visible after campaign start + auth bootstrap emits actor storage state.
- FT-0204
  - Must add test: `packages/cli/src/ft-0204-xe-cli.test.ts`
  - Must run: `xe scenarios/runs/auth/artifacts/lock` command surface in human + `--json`.
- FT-0205
  - Must add test: `packages/xe-runner/src/ft-0205-scenarios.test.ts`
  - Must run: local + beta `xe runs run XE-001` full pass with state/artifacts.
- FT-0206
  - Must run: screenshots captured from independent actor sessions using XE POM/browser contract.
- FT-0207
  - Must run: `XE-001` happy path on `local` and `beta`, expected results parity and visibility checks.

### EP-020 execution evidence (2026-03-07)
- FT-0201: what=XE run registry, workspace provisioning, environment lock and explicit cleanup; where=local packages + beta-backed DB; how=`pnpm --filter @feedback-360/db lint`, `pnpm --filter @feedback-360/db typecheck`, `pnpm --filter @feedback-360/db test`, `pnpm --filter @feedback-360/cli exec vitest run src/ft-0204-xe-cli.test.ts`; quality_gate=passed; acceptance_gate=passed (run registry + lock lifecycle + delete/expired cleanup semantics); artifacts=`.memory-bank/evidence/EP-020/FT-0201/2026-03-07/beta-run.json`; result=passed.
- FT-0202: what=named seed subsystem for `XE-001-first-campaign`; where=local packages + beta-backed DB; how=`pnpm --filter @feedback-360/db test`, `pnpm --filter @feedback-360/xe-runner exec vitest run src/ft-0205-scenarios.test.ts`; quality_gate=passed; acceptance_gate=passed (deterministic bindings for company/campaign/actors/competencies persisted to run state); artifacts=`.memory-bank/evidence/EP-020/FT-0202/2026-03-07/beta-bindings.json`; result=passed.
- FT-0203: what=test notification surface + auth bootstrap into real browser sessions; where=beta `https://beta.go360go.ru`; how=`pnpm --filter @feedback-360/cli exec vitest run src/ft-0204-xe-cli.test.ts`, `pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env beta --owner codex --base-url https://beta.go360go.ru --json`; quality_gate=passed; acceptance_gate=passed (campaign start produced invite intents, actor storage-state bootstrap created usable sessions); artifacts=`.memory-bank/evidence/EP-020/FT-0203/2026-03-07/beta-notifications.json`, `.memory-bank/evidence/EP-020/FT-0203/2026-03-07/beta-sessions.json`; result=passed.
- FT-0204: what=XE CLI surface (`scenarios/runs/phases/seeds/auth/artifacts/notifications/lock`); where=local CLI + beta run; how=`pnpm --filter @feedback-360/cli lint`, `pnpm --filter @feedback-360/cli typecheck`, `pnpm --filter @feedback-360/cli test`, `pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env beta --owner codex --base-url https://beta.go360go.ru --json`; quality_gate=passed; acceptance_gate=passed (CLI covers creation, execution, inspection and lock operations in stable JSON form); artifacts=`.memory-bank/evidence/EP-020/FT-0204/2026-03-07/scenario.json`; result=passed.
- FT-0205: what=file-based scenario runner and phase execution; where=local (`http://127.0.0.1:3105`) + beta (`https://beta.go360go.ru`); how=`pnpm --filter @feedback-360/xe-runner lint`, `pnpm --filter @feedback-360/xe-runner typecheck`, `pnpm --filter @feedback-360/xe-runner test`, `pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env local --owner codex --base-url http://127.0.0.1:3105 --json`, `pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env beta --owner codex --base-url https://beta.go360go.ru --json`; quality_gate=passed; acceptance_gate=passed (all 5 phases pass, state/bindings/artifacts persisted, failed runs preserved for investigation policy); artifacts=`.memory-bank/evidence/EP-020/FT-0205/2026-03-07/beta-state.json`, `.memory-bank/evidence/EP-020/FT-0205/2026-03-07/beta-progress.json`; result=passed.
- FT-0206: what=UI automation contract with one actor per browser context and captured results surfaces; where=beta `https://beta.go360go.ru`; how=`pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env beta --owner codex --base-url https://beta.go360go.ru --json`; quality_gate=passed; acceptance_gate=passed (independent actor sessions opened without GUI login flow, results screenshots captured through XE POM/browser helpers); artifacts=`.memory-bank/evidence/EP-020/FT-0206/2026-03-07/employee-results.png`, `.memory-bank/evidence/EP-020/FT-0206/2026-03-07/manager-results.png`, `.memory-bank/evidence/EP-020/FT-0206/2026-03-07/hr-results.png`; result=passed.
- FT-0207: what=`XE-001` first full cross-epic scenario; where=local (`http://127.0.0.1:3105`) + beta (`https://beta.go360go.ru`); how=`pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env local --owner codex --base-url http://127.0.0.1:3105 --json` (`RUN-20260307121405-25bdb060`), `pnpm --filter @feedback-360/cli cli -- xe runs run XE-001 --env beta --owner codex --base-url https://beta.go360go.ru --json` (`RUN-20260307121525-c767edf3`); quality_gate=passed (`pnpm --filter @feedback-360/db test`, `pnpm --filter @feedback-360/xe-runner test`, `pnpm --filter @feedback-360/cli test`); acceptance_gate=passed (HR setup, start campaign, session bootstrap, deterministic questionnaire submit, results parity against fixture, employee/manager/HR UI verification); artifacts=`.memory-bank/evidence/EP-020/FT-0207/2026-03-07/`; result=passed.

## EP-023 Documentation traceability and SSoT hardening
- FT-0231
  - Must roll out: `@docs` / `@see` on route pages and key core/client/cli entrypoints.
- FT-0232
  - Must complete: route-level screen specs and align them to the shared template.
- FT-0233
  - Must add: implementation/test ownership links in priority spec docs.
- FT-0234
  - Must normalize: governed frontmatter/status metadata across plans/spec/guides/UI docs.
- FT-0235
  - Must add: quick-reference docs for roles, statuses, routes, and XE beta access.
- FT-0236
  - Must extend: `docs:audit` so traceability regressions fail locally before merge.

### EP-023 execution evidence (2026-03-09)
- FT-0231: what=route-level pages and key core/client/cli entrypoints now expose normative docs via JSDoc; where=workspace code; how=`pnpm docs:audit`, `pnpm --filter @feedback-360/web lint`, `pnpm --filter @feedback-360/web typecheck`, `pnpm --filter @feedback-360/core typecheck`, `pnpm --filter @feedback-360/client typecheck`, `pnpm --filter @feedback-360/cli typecheck`, `rg -L "@docs" apps/web/src/app/**/page.tsx`, `rg -L "@docs" packages/core/src/features/*.ts packages/client/src/features/*.ts packages/cli/src/index.ts packages/cli/src/legacy.ts packages/cli/src/auth-provisioning.ts`; quality_gate=passed; acceptance_gate=passed; result=passed.
- FT-0232: what=screen registry and route-level screen specs completed to a shared contract template; where=.memory-bank UI spec; how=`pnpm docs:audit`, `rg -n "planned" .memory-bank/spec/ui/screen-registry.md`; quality_gate=passed; acceptance_gate=passed (no coded route screens left planned; all route screens have deep specs); result=passed.
- FT-0233: what=priority specs now point to implementation entrypoints and primary tests; where=.memory-bank domain/security/notifications/UI specs; how=`pnpm docs:audit`, manual inspection of auth/campaign/questionnaire/results/notifications specs; quality_gate=passed; acceptance_gate=passed; result=passed.
- FT-0234: what=governed docs normalized around canonical frontmatter and status conventions; where=.memory-bank plans/spec/guides/ui screens; how=`pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-023`; quality_gate=passed; acceptance_gate=passed; result=passed.
- FT-0235: what=`guides/reference/` populated with role/status/route/XE quick refs; where=.memory-bank/guides/reference; how=`pnpm docs:audit`, `find .memory-bank/guides/reference -maxdepth 1 -type f | sort`; quality_gate=passed; acceptance_gate=passed; result=passed.
- FT-0236: what=default docs audit extended into traceability audit for code/docs parity; where=`scripts/audit-memory-bank.mjs`, root `package.json`; how=`pnpm docs:audit`, `node scripts/audit-memory-bank.mjs --ep EP-023`; quality_gate=passed; acceptance_gate=passed; result=passed.
