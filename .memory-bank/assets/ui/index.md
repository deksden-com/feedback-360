...
- [`stitch_go360go/employee_my_results_report/screen.png`](stitch_go360go/employee_my_results_report/screen.png): референс личного отчёта сотрудника. Читать для EP-015, чтобы оформить summary, групповые блоки и AI summary без нарушения visibility rules.
- [`stitch_go360go/hr_admin_employee_directory/screen.png`](stitch_go360go/hr_admin_employee_directory/screen.png): референс справочника сотрудников. Читать для EP-016, чтобы унифицировать table/filter patterns в HR-зоне.
...
- [`stitch_go360go/_2/screen.png`](stitch_go360go/_2/screen.png): референс departments/org management. Читать для EP-016, чтобы наметить layout дерева подразделений и admin actions.
- [`stitch_go360go/_3/screen.png`](stitch_go360go/_3/screen.png): референс manager-oriented dashboard. Читать для EP-011 и EP-015, чтобы оформить manager home и team results entry points.
- [`stitch_go360go/_4/screen.png`](stitch_go360go/_4/screen.png): референс competency/model editor. Читать для EP-017, чтобы оформить HR интерфейс моделей компетенций.
- [`stitch_go360go/_5/screen.png`](stitch_go360go/_5/screen.png): референс compact role comparison cards. Читать для EP-011 и EP-015, чтобы подсмотреть layout summary cards и quick comparisons.
