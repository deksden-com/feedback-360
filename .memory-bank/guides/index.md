...
- [Reference](reference/index.md): короткие lookup-материалы для пользователей и операторов. Читать, когда нужно быстро свериться с ролями, экранами, статусами или маршрутами.
